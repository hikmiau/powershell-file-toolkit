...
$managedFolders = @($configData.folders.PSObject.Properties.Name + $configData.fallbackFolder + $configData.duplicateFolder) | Select-Object -Unique
...
foreach ($file in $files) {
    ...
    if ($Recurse -and (Test-InManagedFolder -FilePath $file.FullName -RootPath $Path -FolderNames $managedFolders)) {
        continue
    }
